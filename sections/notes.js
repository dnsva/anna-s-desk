var NotesSection = {
  ...
  render(ctx) {
    ...
    const fmtBg=(k)=>fmt[k]?'background:#BCC8D6;border-radius:7px;':'';
    ...
    const noteFmtBoldStyle=`width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:7px;cursor:pointer;font-weight:700;font-size:14px;color:#2C3646;${fmtBg('bold')}`;
    const noteFmtItalicStyle=`width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:7px;cursor:pointer;font-style:italic;font-size:14px;color:#2C3646;${fmtBg('italic')}`;
    const noteFmtUnderlineStyle=`width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:7px;cursor:pointer;font-size:14px;color:#2C3646;text-decoration:underline;${fmtBg('underline')}`;
    const noteFmtStrikeStyle=`width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:7px;cursor:pointer;font-size:14px;color:#2C3646;text-decoration:line-through;${fmtBg('strike')}`;
    const noteFmtUlStyle=`width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:7px;cursor:pointer;font-size:16px;color:#2C3646;${fmtBg('ul')}`;
    const noteFmtOlStyle=`width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:7px;cursor:pointer;font-size:12px;color:#2C3646;font-weight:600;${fmtBg('ol')}`;
    return {
