var RecipesSection = {
  ...
  render(ctx) {
    ...
    var tabStyle=(on)=>`padding:9px 20px;border-radius:11px;font-size:14px;font-weight:600;cursor:pointer;background:${on?'#6A8FAF':'transparent'};color:${on?'#EBF3FB':'#5A7090'};`;
