var TrashSection = {
  ...
  render(ctx) {
    ...
    const typeLabel={note:'Note',recipe:'Recipe',checklist:'Checklist',date:'Key Date',habit:'Habit',photo:'Photo'};
    const typeColor={note:'#8b3020',recipe:'#d4845a',checklist:'#c4622d',date:'#b85060',habit:'#c4622d',photo:'#b05040'};
